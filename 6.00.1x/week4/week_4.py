...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  6 10:11:03 2022
...
Your task is to change the definition of simple_divide so that the call does 
not raise an exception. When dividing by 0, fancy_divide should return a list 
